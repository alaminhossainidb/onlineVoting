                ...
                <div id="header" class="">
                    ...
                    <div id="nav" class="">
                        <ul>
                        	...
                        	<li><a href=""></a></li>
                        	<li><a href=""></a></li>
                            <li><a href="/addPartyPage">Add Party</a></li>
                            <li><a href="/addCandidatePage">Add Candidate</a></li>
                            <li><a href="/addVotingTypePage">Add Voting Type</a></li>
                            <li><a href="/searchResultPage">Result</a></li>
